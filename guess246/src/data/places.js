...
export const PLACES = {
  easy: [
    ...
    { street: "Highway 1, Holetown", parish: "St. James", lat: 13.1911512, lon: -59.6382856, heading: 146.49 },
    { street: "Carlisle Bay", parish: "St. Michael", lat: 13.086209, lon: -59.6092, heading: 253.45, pitch: 12.04 },
    { street: "Highway 7, Rockley", parish: "Christ Church", lat: 13.0746696, lon: -59.5891528, heading: 139.32 },
...
export const DIFFICULTY = {
  easy: {
    ...
    blurb: "Famous roads, no clock. A likkle limin' warm-up.",
    rounds: 8,
    options: 4,
    timer: null,
    base: 100,
  ...
  hard: {
    ...
    blurb: "Back roads, 6 choices, 12 seconds. Real Bajan only.",
    rounds: 8,
    options: 6,
    timer: 12,
    base: 300,
